    ...
    <div className="p-10 w-[100%]">
      <div className="grid grid-cols-1 md:grid-cols-2  gap-1 ">
        <div className="w-[50vw] grid gap-4 grid-cols-1 p-5 ">
          ...
          <p className="text-xl font-bold ml-2" style={{ textAlign: "left" }}>
          ...
          >
            <button
              className="pr-8 h-10  bg-green-600 w-1/3   rounded-3xl text-white"
              onClick={() => setDate("")}
            >
            ...
            {!Date && (
              <img
                className="w-[15%] h-[100%] rounded-[50%]"
        ...
        <div className="w-[70%]  grid items-center justify-center  rounded-3xl">
          <p className="text-xl font-bold text-center "> Select A day </p>
          <div className="w-[100%] h-[100%] border-0">
            <DatePicker
              className="w-[100%] border-0 p-10"
              onChange={onChange}
            />
          </div>
        </div>
