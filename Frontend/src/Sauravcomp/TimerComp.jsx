  ...
  return (
    <div className="w-[100%] flex h-20 border-2 items-center justify-between pl-5">
      <div>
        ...
        />
        <AddTask isAdd={add} setAdd={setAdd} handlePost={handlePost} task={task} startduration={startduration} endduration={endduration} settask={settask} note={note} setisNotes={setisNotes} />
      </div>
      ...
      <div className="flex w-[100%] h-20  items-center justify-between">
        ...
        {!starttimer ? (
          <div className="flex gap-4">
            <input className="" onChange={(e)=>setstartduration(e.target.value)}  type="time" placeholder={time} />
            <p>-</p>
            <input className="" onChange={(e)=>setendduration(e.target.value)} type="time" placeholder={time} />
          </div>
        ) : (
          ""
        )}
        ...
        {!starttimer ? (
          ...
          <button
            className={`text-blue-700 ${!istimerSTrated && "hidden"}  font-semibold`}
